...
- `references/domains/changelog-automation/`
- `references/domains/compliance-copyright/`
- `references/domains/core/`
- `references/domains/document-formats/`
- `references/domains/engineering/`
- `references/domains/internal-communications/`
- `references/domains/manual-generation/`
- `references/domains/rules/`
- `references/domains/text-formatting/`
...
- `changelog-generator`
  ...
  - 相对路径: `references/domains/changelog-automation/SKILL.md`
...
- `xlsx`
  ...
  - 相对路径: `references/domains/document-formats/xlsx/SKILL.md`
...
- `internal-comms`
  ...
  - 相对路径: `references/domains/internal-communications/SKILL.md`
...
- `software-manual`
  ...
  - 相对路径: `references/domains/manual-generation/SKILL.md`
...
- `text-formatter`
  ...
  - 相对路径: `references/domains/text-formatting/SKILL.md`
